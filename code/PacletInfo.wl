...
PacletObject[
  <|
    "Name" -> "DanieleGregori/ArXivExplore",
    "Description" -> "High level tools for the deep data analysis of all research articles on arXiv",
    ...
    "Extensions" -> {
      {
        ...
        "Symbols" -> {
          ...
          "DanieleGregori`ArXivExplore`ArXivDatasetSubset",
          ...
          "DanieleGregori`ArXivExplore`ArXivPlot",
          "DanieleGregori`ArXivExplore`ArXivPlotAbstracts",
          "DanieleGregori`ArXivExplore`ArXivPlotTitles",
      ...
      },
      {
        ...
        "Assets" -> {
          {
            "database-part-1",
            "arxiv-database-2026-06-1.json"
          },
          {
            "database-part-2",
            "arxiv-database-2026-06-2.json"
          },
          {
            "database-part-3",
            "arxiv-database-2026-06-3.json"
          },
          {
            "database-part-4",
            "arxiv-database-2026-06-4.json"
          },
          {
            "database-part-5",
            "arxiv-database-2026-06-5.json"
          },
          {
            "database-part-6",
            "arxiv-database-2026-06-6.json"
          },
          {
            "database-part-7",
            "arxiv-database-2026-06-7.json"
          },
          {
            "database-part-8",
            "arxiv-database-2026-06-8.json"
          },
          {
            "database-part-9",
            "arxiv-database-2026-06-9.json"
          },
          {
            "database-part-10",
            "arxiv-database-2026-06-10.json"
          }
        }
      }
    }
